...
time.sleep(2)
print(Fore.GREEN+"<------------------------------------------------------->")
print(Fore.GREEN+"Version 1.0	  (20/10/2021)     C0d3d by An0n K4ndar ")
print(Fore.GREEN+"┌───────────────────────────────────────────────────────┐")
...
print(Fore.GREEN+"├───────────────────────────────────────────────────────┤")
print(Fore.GREEN+"│ Link: https://github.com/An0nK4ndar │")
print(Fore.GREEN+"└───────────────────────────────────────────────────────┘")
print("")
time.sleep(1)
print (Fore.BLUE+"> An0n K4ndar offical")
time.sleep(1)
print (Fore.BLUE+"> Current build: 1.0")
time.sleep(3)
print (Fore.GREEN+">>>Code By An0n K4ndar<<<")
time.sleep(2)
print (Fore.BLUE+"> Thanks To:")
print (Fore.CYAN+">>>An0nK4ndar")
print (Fore.CYAN+">>>Fatallerror89")
print (Fore.CYAN+">>>Seypul S.F")
